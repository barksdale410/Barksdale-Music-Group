        ...
        <div className="border-t border-gray-100 mt-2 pt-2">
          <div className="flex gap-2 p-1">
            ...
            <button 
              ...
              className="px-3 py-1.5 bg-[var(--bmg-accent-primary)] text-white text-[10px] font-bold rounded-lg"
            >
              Set
            </button>
          </div>
    ...
    return (
      <div className="relative">
        {value ? (
          ...
          <button 
            onClick={(e) => { e.stopPropagation(); setActiveSelector(activeSelector?.sectionId === s.id && activeSelector?.type === type ? null : { sectionId: s.id, type }); }}
            className="px-3 py-1 bg-white border border-dashed border-gray-200 rounded-lg text-gray-400 font-medium hover:border-blue-300 hover:text-[var(--bmg-accent-primary)] transition-all text-xs flex items-center gap-1.5"
          >
